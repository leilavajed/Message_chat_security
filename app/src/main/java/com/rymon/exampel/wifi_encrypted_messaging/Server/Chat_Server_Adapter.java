...
//ListView Adapter for show message in Server activity
class Chat_Server_Adapter extends ArrayAdapter<ChatMessage> {
    ...
    public void add(final ChatMessage object) {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                Chat_Server_Adapter.super.add(object);
            }
        });
    }

    public Chat_Server_Adapter(Context context, int textViewResourceId) {
